    ...
    <div className="bg-background text-foreground min-h-screen font-sans">
      ...
      <header className="pt-20 pb-16 px-4 max-w-4xl mx-auto text-center space-y-8 select-none">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link href="/stocks" passHref>
            <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-6 px-8 rounded-xl cursor-pointer shadow-sm">
              Analyze a Stock
            </Button>
          </Link>
          <Link href="/trading-journal" passHref>
            <Button size="lg" className="w-full sm:w-auto border border-border bg-card hover:bg-muted text-foreground font-bold py-6 px-8 rounded-xl cursor-pointer shadow-sm">
              Trading Journal
            </Button>
          </Link>
        </div>
      ...
      <section className="py-16 px-4 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card 1 */}
          <div className="border border-border rounded-xl bg-card p-6 flex flex-col justify-between h-[300px] hover:border-primary transition-all duration-200 shadow-sm">
            <div className="space-y-3">
              <div className="text-primary p-2 bg-primary/10 border border-border rounded-lg w-10 h-10 flex items-center justify-center">
            ...
            <Link href="/stocks" className="text-xs font-bold text-primary flex items-center gap-1 hover:text-primary/80 pt-4">
          ...
          <div className="border border-border rounded-xl bg-card p-6 flex flex-col justify-between h-[300px] hover:border-primary transition-all duration-200 shadow-sm">
            ...
            <Link href="/scanner" className="text-xs font-bold text-primary flex items-center gap-1 hover:text-primary/80 pt-4">
          ...
          <div className="border border-border rounded-xl bg-card p-6 flex flex-col justify-between h-[300px] hover:border-primary transition-all duration-200 shadow-sm">
            ...
            <Link href="/trading-journal" className="text-xs font-bold text-primary flex items-center gap-1 hover:text-primary/80 pt-4">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto flex flex-col items-center border-t border-border">
        <div className="w-full max-w-[650px] border border-border bg-card rounded-xl p-6 sm:p-10 space-y-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 bg-muted border border-border p-4 rounded-lg select-none">
            <div className="space-y-0.5">
              <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider block">Time Required</span>
              <span className="text-sm font-bold text-foreground">10 min / Day</span>
            </div>
            <div className="space-y-0.5">
              <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider block">Cost</span>
            ...
            return (
              <div key={index} className="p-5 space-y-2">
                <button
                  ...
                  className="flex w-full items-center justify-between gap-4 text-left font-bold text-foreground hover:text-primary transition-colors cursor-pointer text-xs sm:text-sm"
                >
                  <span>{faq.question}</span>
                  <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform ${isActive ? "rotate-180 text-primary" : ""}`} />
                </button>
                {isActive && (
