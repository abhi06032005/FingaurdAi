...
import { calculateAllIndicators } from './services/indicators/indicatorOrchestrator';
import { generateSignals } from './services/signals/signalEngine';
import { calculateTechnicalScore } from './services/scoring/technicalScorer';
import { calculateConfluence } from './services/scoring/confluenceEngine';
...
const indicators = calculateAllIndicators(mockCandles);
...
const scoreResult = calculateTechnicalScore(indicators, currentPrice);
