...
const AiReportSchema = new mongoose_1.Schema({
    ...
    indicators: { type: mongoose_1.Schema.Types.Mixed, required: true },
    generatedAt: { type: Date, default: Date.now },
    modelUsed: { type: String, required: true }
});
// Compound index to quickly fetch cached summaries
AiReportSchema.index({ symbol: 1, candleDate: -1 });
exports.default = mongoose_1.default.models.AiReport || mongoose_1.default.model('AiReport', AiReportSchema);
