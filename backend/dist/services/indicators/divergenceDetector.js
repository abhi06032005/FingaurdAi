...
exports.detectDivergences = detectDivergences;
const mathUtils_1 = require("../../utils/mathUtils");
/**
 * Detects divergences between price closes and indicators (RSI / MACD histogram).
 */
function detectDivergences(closes, rsiValues, macdHistogram, lookback = 14) {
    const divergences = [];
    ...
    if (alignedCloses.length < lookback + 1)
        return divergences;
        ...
        if (currentRsi !== null && minCloseRsi !== null && maxCloseRsi !== null) {
            ...
            if (currentClose < alignedCloses[minCloseIdx] && currentRsi > minCloseRsi) {
                ...
                divergences.push({
                    type: 'bullish_rsi',
                    strength,
                    description: `Price recorded a lower low, but the RSI value formed a higher low (from ${(0, mathUtils_1.round)(minCloseRsi, 1)} to ${(0, mathUtils_1.round)(currentRsi, 1)}), indicating weakening downward momentum.`
                });
            }
            ...
            if (currentClose > alignedCloses[maxCloseIdx] && currentRsi < maxCloseRsi) {
                ...
                divergences.push({
                    type: 'bearish_rsi',
                    strength,
                    description: `Price recorded a higher high, but the RSI value formed a lower high (from ${(0, mathUtils_1.round)(maxCloseRsi, 1)} to ${(0, mathUtils_1.round)(currentRsi, 1)}), indicating weakening upward momentum.`
                });
            }
        }
    }
        ...
        if (currentMacd !== null && minCloseMacd !== null && maxCloseMacd !== null) {
            ...
            if (currentClose < alignedCloses[minCloseIdx] && currentMacd > minCloseMacd) {
                ...
                divergences.push({
                    type: 'bullish_macd',
                    strength,
                    description: `Price recorded a lower low, but the MACD histogram formed a higher low (from ${(0, mathUtils_1.round)(minCloseMacd, 2)} to ${(0, mathUtils_1.round)(currentMacd, 2)}), suggesting downward momentum is decelerating.`
                });
            }
            ...
            if (currentClose > alignedCloses[maxCloseIdx] && currentMacd < maxCloseMacd) {
                ...
                divergences.push({
                    type: 'bearish_macd',
                    strength,
                    description: `Price recorded a higher high, but the MACD histogram formed a lower high (from ${(0, mathUtils_1.round)(maxCloseMacd, 2)} to ${(0, mathUtils_1.round)(currentMacd, 2)}), suggesting upward momentum is decelerating.`
                });
            }
        }
    }
