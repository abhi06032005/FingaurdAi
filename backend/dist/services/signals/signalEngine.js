...
function generateSignals(indicators, currentPrice) {
    ...
    if (rsiResult !== null) {
        ...
        signals.push({
            indicator: 'RSI (14)',
            value: (0, mathUtils_1.round)(rsi, 1).toString(),
            signal: signalText,
            direction,
            strength,
        });
    ...
    if (macd !== null) {
        ...
        signals.push({
            ...
            value: `Hist: ${(0, mathUtils_1.round)(macd.histogram, 2)}`,
            signal: signalText,
            direction,
            strength,
        });
    ...
    if (trend.sma50 !== null && trend.sma200 !== null) {
        if (currentPrice > trend.sma200 && trend.sma50 > trend.sma200) {
            signals.push({
                ...
                value: `Price > SMA200 (${(0, mathUtils_1.round)(trend.sma200, 1)})`,
    ...
    if (trend.sma50 !== null) {
        signals.push({
            indicator: 'SMA 50',
            value: (0, mathUtils_1.round)(trend.sma50, 1).toString(),
    ...
    if (bb !== null) {
        if (currentPrice > bb.upper) {
            signals.push({
                ...
                value: `Price > Upper (${(0, mathUtils_1.round)(bb.upper, 1)})`,
            ...
            signals.push({
                indicator: 'Bollinger Bands',
                value: `Price < Lower (${(0, mathUtils_1.round)(bb.lower, 1)})`,
        ...
        if (bb.percentB > 0.8) {
            signals.push({
                ...
                value: (0, mathUtils_1.round)(bb.percentB, 2).toString(),
        ...
        if (bb.bandwidthState === 'contracting') {
            signals.push({
                ...
                value: (0, mathUtils_1.round)(bb.bandwidth, 3).toString(),
    ...
    if (adx !== null) {
        ...
        signals.push({
            indicator: 'ADX (14)',
            value: (0, mathUtils_1.round)(adx.adx, 1).toString(),
            signal: signalText,
            direction,
            strength,
        });
    ...
    if (stoch !== null) {
        ...
        signals.push({
            indicator: 'Stoch RSI',
            value: `K: ${(0, mathUtils_1.round)(stoch.k, 1)}`,
            signal: signalText,
            direction,
            strength,
        });
    ...
    if (obv !== null) {
        ...
        signals.push({
            indicator: 'OBV',
            value: (0, mathUtils_1.round)(obv.obv, 0).toString(),
            signal: signalText,
            direction,
            strength,
        });
